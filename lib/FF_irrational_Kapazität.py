...
def FordFulkerson(network, output_dir):
    ...
    # Gleich wie in allgemeiner FF-Implementierung
    ...
    while path is not None:
        # Sicherstellen, dass der Pfadfluss die rekursive Beziehung bildet, weil es sonst zu unendlichen Schleifen kommen kann
        if iteration % 2 == 0:
            flow = an
        else:
            flow = an_plus_1

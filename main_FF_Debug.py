...
if Suchmethode == "DFS":
    from lib.WIP_FF import FordFulkerson_Debug
elif Suchmethode == "BFS":
    from lib.FF_BFS import FordFulkerson_Debug
...
core_usage_path = f"Output/FF_Output/Auslastung_Debug_{input_filename}.json"
